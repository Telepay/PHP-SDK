...
class PosService extends BaseService {
    ...
    public function generateV3($amount, $description, $currency_in, $currency_out, $url_notification, $url_ok, $url_ko, $order_id, $id, $signature){
        return $this->call(
            'pos/v2/transaction/'.$id,
            array(),
            'POST',
    ...
    public function generateV4($amount, $description, $currency_in, $currency_out, $url_notification, $url_ok, $url_ko, $order_id, $id, $signature, $mode){
        return $this->call(
            'pos/v2/transaction/'.$id,
            array(),
            'POST',
